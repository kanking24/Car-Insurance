...
function eventListeners(){
     ...
     form.addEventListener('submit', function(e){
         ...
         if(year === '' || make === '' || level === ''){
              ...
              const price = insurance.calculateQuotiation(insurance);
...
Insurance.prototype.calculateQuotiation = function(insurance){
     let price;
     const base = 2000;
...
//This is Extra for my understanding 
// if we put all the function inside the function it would make it heavy so we use:

// functionName.prototype.currentFucntion = function(){
//      ------------------- code snippet ---------------------------
// }


// HTMLUI.prototype.displayBuilds = function(){
...
//           const build = document.createElement('models')
//           build.value = i;
//           build.textContent = i;
//           selectBuilds.appendChild(build)
